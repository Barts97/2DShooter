...
pygame.display.set_caption ('Ians Game')
...
#music upload 
pygame.mixer.music.load('audio/The_world_spear.mp3')
...
health_fx.set_volume(0.6)
ammo_fx = pygame.mixer.Sound('audio/ammo.wav')
ammo_fx.set_volume(0.6)
hurt_fx = pygame.mixer.Sound('audio/hurt.wav')
hurt_fx.set_volume(0.6)
evil_laugh_fx = pygame.mixer.Sound('audio/evil_laugh.wav')
evil_laugh_fx.set_volume(0.4)
grenade_pickup_fx = pygame.mixer.Sound('audio/grenade_pickup.wav')
grenade_pickup_fx.set_volume(0.5)
...
class Soldier(pygame.sprite.Sprite):
    ...
    def move(self, moving_left, moving_right):
        ...
        #check water collision so player dies
        if pygame.sprite.spritecollide(self, water_group , False):
            self.health = 0
        
        #check collision for exit
    ...
    def ai(self):
        if self.alive and player.alive:
            if self.idling == False and random.randint(1, 320) == 1:
...
class SpringSprite( pygame.sprite.Sprite ):
    def __init__( self ):
        pygame.sprite.Sprite.__init__( self )
        self.upright     = pygame.image.load("crouching.png").convert_alpha()            
        self.compressed  = pygame.image.load("crouching.png").convert_alpha() 
        self.image       = self.upright
        self.rect        = self.image.get_rect()
        self.rect.center = ( SCREEN_WIDTH//2, SCREEN_HEIGHT//2 )
        self.crouched    = False
        self.height_delta= ( self.upright.get_height() - self.compressed.get_height() ) // 2 
            ...
            for x, tile in enumerate(row):
                if tile >= 0:
                    ...
                    if tile >= 0 and tile <= 8:
                        ...
                        player = Soldier('player', x * TILE_SIZE, y * TILE_SIZE, 1.65, 6, 25, 3)
...
class HealthBar():
    ...
    def draw(self, health):
        ...
        pygame.draw.rect(screen, VAMPIRE_BLACK, (self.x - 2, self.y - 2, 154, 24))
...
class Grenade(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        if self.timer <= 0:
            self.kill()
            grenade_fx.play()
            explosion = Explosion(self.rect.x, self.rect.y, 0.2)
...
class ScreenFade():
    ...
    def fade(self):
        ...
        if self.direction == 2:   # scren fade down
...
death_fade = ScreenFade(2 , DIM_GREY , 4)
...
while run:
    ...
    if start_game == False:
        ...
        #show ammo
        draw_text('AMMO: ', font, RED_DEVIL, 10, 35)
        for x in range(player.ammo):
            screen.blit(bullet_img, (90 + (x * 10), 40))
        #show grenades
        draw_text('GRENADES: ', font, RED_DEVIL , 10, 60)
